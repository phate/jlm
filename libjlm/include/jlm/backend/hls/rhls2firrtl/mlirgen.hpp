//
// Created by Magnus Sjalander 26 December 2021
//
...
namespace jlm {
	namespace hls{
		...
		public:
			std::string get_text(jlm::RvsdgModule &rvsdgModule) {return "MLIR/FIRRTL generator";}
		...
		class MLIRGen : public BaseHLS {
			...
			std::string get_text(jlm::RvsdgModule &rm) {return "";}
		public:
			void
