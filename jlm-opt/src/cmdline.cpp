...
parse_cmdline(int argc, char ** argv, jlm::cmdline_options & options)
{
  ...
  cl::list<StatisticsDescriptor::StatisticsId> printStatistics(
    cl::values(
        ...
        clEnumValN(StatisticsDescriptor::StatisticsId::BasicEncoderContextCreation,
                   "print-basicencoder-contextcreation",
                   "Write context creation statistics of basic encoder to file."),
