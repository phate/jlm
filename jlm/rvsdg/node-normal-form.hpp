...
{
public:
  virtual ~node_normal_form() noexcept;
  ...
  inline bool
  get_mutable() const noexcept
  {
    return enable_mutable_;
  }
...
typedef jlm::util::owner_intrusive_hash<
    ...
    jlm::rvsdg::node_normal_form::opclass_hash_accessor>
    node_normal_form_hash;
