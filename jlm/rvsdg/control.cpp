...
template class domain_const_op<ControlType, ControlValueRepresentation, ctlformat_value, ctltype_of_value>;
...
{
  return CreateOpNode<ctlconstant_op>(*region, ControlValueRepresentation(alternative, nalternatives)).output(0);
}
