 ...
 *
 * 4. Find Allocas live in SCC: For each SCC in the call graph, the set of Allocas that may be live
 * while a function in the SCC is on the top of the call stack.
 *
 * (4.5. Find Allocas reachable in Function): Skip for now, use the SCC instead
 *
 * 6. Mod/Ref Graph Building: Creates a graph containing nodes for loads, stores, calls,
 ...
 *
 * 7. Mod/Ref Graph Solving: Mod/Ref sets are propagated along edges in the graph
 *
