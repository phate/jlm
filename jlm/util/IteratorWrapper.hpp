 ...
 * The iterator may for example be a \c std::vector<std::unique_ptr<T>>::iterator.
 *
 ...
 * The iterator may for example be an \c std::unordered_map<int, std::unique_ptr<T>>::iterator.
 *
 * @tparam T the result type
 * @tparam BaseIterator the iterator type
 */
