    ...
    const ::llvm::SmallVector<::mlir::Value> & inputs)
{
  ...
  else if (auto fpOp = dynamic_cast<const llvm::ConstantFP *>(&(node.operation())))
  {
  ...
  else if (auto fpBinOp = dynamic_cast<const jlm::llvm::fpbin_op *>(&(node.operation())))
  {
  ...
  else if (auto sextOp = dynamic_cast<const jlm::llvm::sext_op *>(&(node.operation())))
  {
  ...
  else if (auto sitofpOp = dynamic_cast<const jlm::llvm::sitofp_op *>(&(node.operation())))
  {
  ...
  else if (auto vaOp = dynamic_cast<const llvm::valist_op *>(&(node.operation())))
  {
  ...
  else if (auto freeOp = dynamic_cast<const jlm::llvm::FreeOperation *>(&node.operation()))
  {
  ...
  else if (auto alloca_op = dynamic_cast<const jlm::llvm::alloca_op *>(&node.operation()))
  {
  ...
  else if (auto load_op = dynamic_cast<const jlm::llvm::LoadOperation *>(&node.operation()))
  {
  ...
  else if (auto store_op = dynamic_cast<const jlm::llvm::StoreOperation *>(&node.operation()))
  {
  ...
  else if (rvsdg::is<jlm::llvm::MemoryStateMergeOperation>(node.operation()))
  {
...
JlmToMlirConverter::ConvertType(const rvsdg::Type & type)
{
  ...
  else if (auto fpt = dynamic_cast<const jlm::llvm::fptype *>(&type))
  {
  ...
  else if (rvsdg::is<const llvm::varargtype>(type))
  {
