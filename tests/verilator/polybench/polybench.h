...
#define POLYBENCH_2D_ARRAY_DECL(var, type, dim1, dim2, ddim1, ddim2)      \
  ...
  var = POLYBENCH_ALLOC_2D_ARRAY(                                         \
      POLYBENCH_C99_SELECT(dim1, ddim1),                                  \
...
#define POLYBENCH_4D_ARRAY_DECL(var, type, dim1, dim2, dim3, dim4, ddim1, ddim2, ddim3, ddim4)     \
  type                                                                                             \
      POLYBENCH_4D_F(POLYBENCH_DECL_VAR(var), dim1, dim2, dim3, dim4, ddim1, ddim2, ddim3, ddim4); \
  var = POLYBENCH_ALLOC_4D_ARRAY(                                                                  \
      POLYBENCH_C99_SELECT(dim1, ddim1),                                                           \
      POLYBENCH_C99_SELECT(dim2, ddim2),                                                           \
      POLYBENCH_C99_SELECT(dim3, ddim3),                                                           \
      POLYBENCH_C99_SELECT(dim4, ddim4),                                                           \
      type);
#define POLYBENCH_5D_ARRAY_DECL(         \
    var,                                 \
    type,                                \
    dim1,                                \
    dim2,                                \
