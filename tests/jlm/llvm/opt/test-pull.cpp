...
test_pull()
{
  ...
  /* inner gamma */
  auto gamma2 = jlm::rvsdg::GammaNode::create(ev1.branches[1], 2);
  auto ev3 = gamma2->AddEntryVar(ev2.branches[1]);
  auto cg2 = jlm::tests::create_testop(gamma2->subregion(0), {}, { vt })[0];
  auto un = jlm::tests::create_testop(gamma2->subregion(1), { ev3.branches[1] }, { vt })[0];
