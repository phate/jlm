...
test_gamma()
{
  ...
  gamma->add_exitvar({ ev1.branches[0], ev1.branches[1] });
  gamma->add_exitvar({ ev2.branches[0], ev2.branches[1] });
  gamma->add_exitvar({ ev3.branches[0], ev3.branches[1] });
  gamma->add_exitvar({ n1, ev3.branches[1] });
  gamma->add_exitvar({ n2, ev3.branches[1] });
  gamma->add_exitvar({ n3, ev3.branches[1] });
  gamma->add_exitvar({ ev5.branches[0], ev4.branches[1] });
