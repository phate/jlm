...
TestUsedMemoryState()
{
  ...
  // Act
  RemoveLambdaInvariantStateEdges(*rvsdgModule);
  // Assert
  jlm::rvsdg::view(rvsdgModule->Rvsdg(), stdout);
  auto * node =
      jlm::rvsdg::output::GetNode(*rvsdgModule->Rvsdg().GetRootRegion().result(0)->origin());
  auto lambdaSubregion = jlm::util::AssertedCast<lambda::node>(node)->subregion();
...
JLM_UNIT_TEST_REGISTER(
    "jlm/hls/backend/rvsdg2rhls/InvariantStateRemovalTests-UsedMemoryState",
    TestUsedMemoryState)
...
JLM_UNIT_TEST_REGISTER(
    "jlm/hls/backend/rvsdg2rhls/InvariantStateRemovalTests-UnusedMemoryState",
    TestUnusedMemoryState)
...
JLM_UNIT_TEST_REGISTER(
    "jlm/hls/backend/rvsdg2rhls/InvariantStateRemovalTests-InvariantMemoryState",
    TestInvariantMemoryState)

static int
TestInvariantMemoryStateV2()
{
  using namespace jlm::llvm;
  using namespace jlm::hls;
  ...
  RemoveLambdaInvariantMemoryStateEdges(*rvsdgModule);
  // Assert
  auto * node =
      jlm::rvsdg::output::GetNode(*rvsdgModule->Rvsdg().GetRootRegion().result(0)->origin());
  auto lambdaSubregion = jlm::util::AssertedCast<lambda::node>(node)->subregion();
...
JLM_UNIT_TEST_REGISTER(
    "jlm/hls/backend/rvsdg2rhls/InvariantStateRemovalTests-InvariantMemoryStateV2",
    TestInvariantMemoryStateV2)
