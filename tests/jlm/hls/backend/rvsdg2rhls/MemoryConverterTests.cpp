...
TestThetaLoad()
{
  ...
  auto arm = jlm::rvsdg::simple_node::create_normalized(thetaRegion, add, { idv.pre, lvs.pre })[0];
  auto cmp = jlm::rvsdg::simple_node::create_normalized(thetaRegion, ult, { arm, lve.pre })[0];
