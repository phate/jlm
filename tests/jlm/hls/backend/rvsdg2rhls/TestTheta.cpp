...
TestUnknownBoundaries()
{
  ...
  auto arm = jlm::rvsdg::simple_node::create_normalized(subregion, add, { idv.pre, lvs.pre })[0];
  auto cmp = jlm::rvsdg::simple_node::create_normalized(subregion, ult, { arm, lve.pre })[0];
